        ...
        <header class="dashboard-header">
            <div class="header-left">
                ...
                <p class="page-subtitle">
                    Pantau stok produk, pesanan, dan aktivitas gudang dalam satu tempat.
                </p>
            </div>
            ...
            <div class="header-right">
                <form method="GET" action="{{ route('dashboard') }}" id="filterForm" class="daterange-wrap"
                    ...
                    <input type="text" id="daterange" class="daterange-input" placeholder="Pilih Periode"
                        autocomplete="off" readonly aria-label="Pilih periode data">
