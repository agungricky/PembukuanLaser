...
@section('content')
    <div class="bg-white p-3 p-md-4 rounded shadow-sm w-100">
        ...
        <div class="d-flex flex-wrap gap-2 justify-content-between align-items-center mb-3">
            ...
            <button class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#tambahTransaksiModal">
                ...
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <input type="text" name="search" class="form-control form-control-sm"
                            value="{{ request('search') }}" placeholder="No iklan, toko, marketplace, metode">
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="tanggal_dari" id="min_date" hidden>
                            <input type="text" name="tanggal_sampai" id="max_date" hidden>
                        </div>
                    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-inline-flex gap-1">
                                    ...
                                    <form action="{{ route('iklan.destroy', $data->no_iklan) }}" method="POST"
                                    ...
                                    <form action="{{ route('iklan.update', $data->no_iklan) }}" method="POST">
                                        ...
                                        <div class="modal-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" value="{{ $data->no_iklan }}"
                                                    readonly>
                                            </div>
                                            ...
                                            <div class="row g-2">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    ...
                                                    <input type="number" name="saldo" class="form-control no-dot"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#filterToko').select2({
                theme: 'bootstrap-5',
                width: '100%',
                placeholder: $('#filterToko').data('placeholder'),
                allowClear: true
            });
