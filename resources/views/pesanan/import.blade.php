...
@section('content')
    <div class="bg-white p-4 rounded shadow-sm w-100">
        ...
        {{-- FORM IMPORT --}}
        <form
            action="{{ route('pesanan.preview') }}"
            method="POST"
            enctype="multipart/form-data"
            id="formImportPesanan"
        >
            @csrf
        ...
        (function($) {
            ...
            $(function() {
                ...
                $('#marketplace').on('change', function() {
                    ...
                    const url = "{{ route('pesanan.getToko', ':market') }}"
                        .replace(
                            ':market',
                        ...
                        success: function(response) {
                            ...
                            (response.data || []).forEach(
                                function(item, indexPesanan) {
                                    ...
                                    const produkList =
                                        Array.isArray(item.produk_detail)
                                            ? item.produk_detail
                                            : [];
                                                ...
                                                <tr class="preview-row">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <input
                                                            type="hidden"
                                                            class="field-no-resi"
                                                            value="${escapeHtml(item.no_resi || '')}"
                                                        >

                                                        <input
                                                            type="hidden"
                                                            class="field-kurir"
                                                            value="${escapeHtml(item.kurir || '')}"
                                                        >

                                                        <input
                                                            type="hidden"
                                                            class="field-pembeli"
                                                            value="${escapeHtml(item.nama_pembeli || '')}"
                                                        >
                                                    ...
                                                    <td>
                                                        <input
                                                            type="text"
                                                            class="form-control form-control-sm field-no-pesanan"
                                                            value="${escapeHtml(item.no_pesanan || '')}"
                                                            readonly
                                                        >
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input
                                                            type="text"
                                                            class="form-control form-control-sm field-nama-produk"
                                                            value="${escapeHtml(namaProduk)}"
                                                            readonly
                                                        >
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input
                                                            type="text"
                                                            class="form-control form-control-sm field-variasi"
                                                            value="${escapeHtml(variasi)}"
                                                            readonly
                                                        >
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input
                                                            type="number"
                                                            class="form-control form-control-sm text-center field-jumlah"
                                                            value="${jumlah}"
                                                            min="1"
                                                            readonly
                                                        >
                                                    ...
                                                    <td>
                                                        <input
                                                            ...
                                                            step="0.01"
                                                            min="0"
                                                            class="form-control form-control-sm field-hpp"
                                                            value="${hpp}"
                                                        >
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input
                                                            ...
                                                            step="0.01"
                                                            min="0"
                                                            class="form-control form-control-sm field-harga"
                                                            value="${harga}"
                                                            readonly
                                                        >
                                                    </td>
