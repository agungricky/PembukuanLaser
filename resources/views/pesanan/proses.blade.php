                    ...
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input type="text" class="form-control form-control-sm border-start-0" name="no_pesanan"
                                    value="{{ request('no_pesanan') }}" placeholder="No. pesanan / No. resi">
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-md-1 text-md-end">
                            <a href="{{ route('pesanan.proses') }}" class="btn btn-outline-secondary btn-sm w-100">
                                Reset
                            </a>
                        </div>
            ...
            $('#btn-simpan-status').on('click', function() {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        $('#error-message')
                            .removeClass('d-none')
                            .text('Gagal mengubah status: ' + (xhr.responseText ||
                                'Unknown error'));
                    },
                    complete: function() {
