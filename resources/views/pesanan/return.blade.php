          ...
          <div class="row g-3 align-items-end">
            ...
            <div class="col-12 col-lg-2">
              ...
              <select name="status" class="form-select form-select-sm">
                ...
                <option value="pengembalian" {{ $st==='pengembalian' ? 'selected' : '' }}>Pengembalian</option>
                <option value="pengiriman gagal" {{ $st==='pengiriman gagal' ? 'selected' : '' }}>Pengiriman gagal</option>
              </select>
            </div>
            ...
            @foreach ($pesanan as $p)
              @php
                ...
                $statusMap = [
                  ...
                  'pengiriman gagal' => ['label' => 'Pengiriman Gagal', 'badge' => 'bg-danger text-white'],
                  'pengembalian'     => ['label' => 'Pengembalian',     'badge' => 'bg-danger text-white'],
                ];
                $s = $statusMap[$status] ?? ['label' => ucfirst($status ?: 'Unknown'), 'badge' => 'bg-secondary-subtle text-secondary'];
