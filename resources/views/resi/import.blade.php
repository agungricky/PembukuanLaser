...
@push('scripts')
    <script>
        $(function() {
            ...
            const selectedToko = "{{ old('id_toko', $selectedToko ?? '') }}";
            ...
            function loadToko(marketplace, idToko = '') {

                const selectToko = $('#namaToko');

                selectToko
                    .empty()
                    .append('<option value="">Memuat toko...</option>')
                ...
                if (!marketplace) {
                    ...
                    selectToko
                        .empty()
                        .append('<option value="">Pilih Marketplace dulu</option>')
                        .trigger('change.select2');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        response.forEach(function(toko) {
                            ...
                            if (
                                idToko &&
                                String(toko.id_toko) === String(idToko)
                            ) {
            ...
            const marketplaceAwal = $('#marketplace').val();
            ...
            $('#formImportResi').on('submit', function() {
            ...
            $('#formSimpanResi').on('submit', function() {
